...
from app.models.org_engine.academic import AcademicStatus
from app.models.org_engine.curriculum import ProgramLevel
...
class SemesterCreateSchema(BaseModel):
    academic_year_id: Optional[str] = Field(default=None, alias="academicYearId")
...
class SemesterUpdateSchema(BaseModel):
    academic_year_id: Optional[str] = Field(default=None, alias="academicYearId")
    number: Optional[int] = Field(default=None, ge=1, le=20)  # Explicitly rejected by service
...
class SemesterResponseSchema(BaseModel):
    ...
    organization_id: PyObjectIdStr = Field(..., alias="organizationId")
    academic_year_id: Optional[PyObjectIdStr] = Field(default=None, alias="academicYearId")
    number: int
    name: str
    status: AcademicStatus
    model_config = schema_config
...
class AcademicYearBulkUpdateSchema(BaseModel):
