...
from apps.api.app.models.identity.user import User, Profile, StudentProfile, FacultyProfile, AdminProfile
from apps.api.app.models.identity.rbac import UserRole, Role
