...
from apps.api.app.schemas.capability_schemas import (
    CapabilityCreateSchema, CapabilityUpdateSchema, CapabilityResponseSchema
)
from apps.api.app.services.capability import CapabilityService, get_capability_service
...
async def list_categories():
    from apps.api.app.models.org_engine.capability import CapabilityCategory
