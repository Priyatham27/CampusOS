...
from apps.api.app.core.security import set_auth_cookies, clear_auth_cookies, extract_access_token
...
from apps.api.app.schemas.auth_schemas import AuthResponseDataSchema, AuthUserResponse
from apps.api.app.schemas.session_schemas import (
...
from apps.api.app.api.v1.auth import get_client_ip
...
async def refresh_session(
    ...
    if not refresh_token:
        from apps.api.app.core.session_exceptions import RefreshTokenInvalid
...
async def update_device_trust(
    ...
    if not device or device.user_id != context.user.id:
        from apps.api.app.core.session_exceptions import DeviceNotFound
