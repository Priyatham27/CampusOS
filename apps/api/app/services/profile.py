...
from apps.api.app.core.user_exceptions import ProfileNotFound, UserNotFound
from apps.api.app.repositories.profile import ProfileRepository
from apps.api.app.repositories.user import UserRepository
from apps.api.app.models.identity.user import Profile, User
from apps.api.app.validators.profile import validate_profile_completeness
from apps.api.app.validators.user import validate_phone_format
