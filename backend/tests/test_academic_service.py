...
# Use new DDD Academic Service
from app.academic.service import AcademicService
from app.academic.exceptions import (
    DuplicateDepartment, DuplicateSemester, SemesterSequenceViolation, DepartmentNotFound
)
...
async def test_service_semester_sequential_integrity():
    ...
    with pytest.raises(SemesterSequenceViolation):
